...
CompactResults_PrelimThru2017Day87 <- read.csv("Data/CompactResults_PrelimThru2017Day87.csv")
...
TeamCoaches_PrelimThru2017Day87 <- read.csv("Data/TeamCoaches_PrelimThru2017Day87.csv")
